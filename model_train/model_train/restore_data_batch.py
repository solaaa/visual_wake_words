...
training_data_dir = r'E:\Visual Wake Words\data\coco_dataset\train_resize\freq_data_224'
val_data_dir = r'E:\Visual Wake Words\data\coco_dataset\val_resize\freq_data_224'
if (Path(training_data_dir).exists()==False):
    os.mkdir(training_data_dir)
if (Path(val_data_dir).exists()==False):
    os.mkdir(val_data_dir)

data_processor = input_data.DataProcessor(data_dir, 64, '224 224', 'ycbcr')
...
for i in range(TRAIN_NUM):
    ...
    if i == 0:
        print(data_batch.shape, data_labels.shape)
# val
